const SVGComponent = (props: any) => (
  <svg
    ...
    {...props}>
    <rect width={69.8342} height={26.1865} transform="translate(-12.707) rotate(28)" fill="url(#pattern0_224_4474)" />
    <defs>
      <pattern id="pattern0_224_4474" patternContentUnits="objectBoundingBox" width={1} height={1}>
        <use xlinkHref="#image0_224_4474" transform="scale(0.00892861 0.0238108)" />
      </pattern>
      <image
        id="image0_224_4474"
        width={112}
